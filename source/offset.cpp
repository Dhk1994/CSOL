...
PVOID AutoOffset::ClientFuncs()
{
	...
	PVOID ClientPtr = (PVOID)(HwBase + 0x23C3D60); // ClientTAB   À¶¾«Áé2493360
...
{
	DWORD Old = NULL;
	PVOID EnginePtr = (PVOID)(HwBase + 0x46C0A8); // ÒýÇæTAB  À¶¾«Áé4A70D8
...
DWORD AutoOffset::FindSpeed(void)
{
	...
	PVOID SpeedPtr = (PVOID)(HwBase + 0x3D1DE0); //speedptr   À¶¾«Áé402078
...
PVOID AutoOffset::FindPlayerMove(void)
{
	...
	PVOID Ptr = (PVOID)(HwBase + 0x1E15C80); //playermove À¶¾«Áé1ECCCC0
